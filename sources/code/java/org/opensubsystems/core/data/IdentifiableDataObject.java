...
public interface IdentifiableDataObject
{
   ...
   /**
    * Set name of the data object
    * 
    * @param strName - name of the generic data
    */
   void setName(
      String strName
   );
   ...
   /**
    * Set description of the data object
    * 
    * @param strDescription - description of the generic data
    */
   void setDescription(
