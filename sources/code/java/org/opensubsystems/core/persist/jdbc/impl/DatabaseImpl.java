 ...
 * @author bastafidli
 */
public abstract class DatabaseImpl extends OSSObject
                                   implements Database
{
   // Constants ////////////////////////////////////////////////////////////////
      ...
      if (s_defaultInstance == null)
      {
         ...
         synchronized (IMPL_LOCK)
         {
            if (s_defaultInstance == null)
            {
               ...
               // TODO: Dependency: This creates compile time dependency on HSQL
               // package and it should be removed so that we can exclude that
               // package if desired
               setInstance(cf.createInstance(Database.class, 
                                             HsqlDBDatabaseImpl.class));
            }
         }   
      }
