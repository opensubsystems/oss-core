...
import org.opensubsystems.core.logic.j2ee.J2EEControllerManager;
      ...
      if (s_defaultInstance == null)
      {
         ...
         synchronized (IMPL_LOCK)
         {
            if (s_defaultInstance == null)
            {
               ...
               // TODO: Dependency: This I believe created dependency on the
               // j2ee package and wouldn't work if the j2ee package is not
               // present (such as on the client)
               if (J2EEUtils.getJ2EEServerType() != J2EEUtils.J2EE_SERVER_NO)
               {
                  defaultManager = J2EEControllerManager.class;
               }
