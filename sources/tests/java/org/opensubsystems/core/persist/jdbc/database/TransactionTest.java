   ...
   public static class TransactionTestInternal extends DatabaseTest
   {
      ...
      ) throws Throwable
      {
         ...
         try
         {
            ...
            try
            {
               ...
               assertEquals("Update count should have been 0", 0, iUpdateCount);
            }
            catch (Throwable throwable)
            {
      ...
      ) throws Throwable
      {
         ...
         try
         {
            ...
            assertEquals("Exactly one record have been inserted.", 1, iUpdateCount);
            ...
            try
            {
               ...
               assertEquals("Exactly one record have been updated.", 1, iUpdateCount);
      ...
      ) throws Throwable
      {
         ...
         try
         {
            ...
            try
            {
               ...
               assertEquals("Exactly 1 record should have been updated", 
                            1, iUpdatedCount);
            }
            finally
            {   
