...
import org.opensubsystems.core.persist.jdbc.impl.ModifiableDatabaseSchemaImpl;
...
{   
    ...
    */
   protected static final Map<Integer, String> TABLE_NAMES;
   ...
   static
   {
      ...
      TABLE_NAMES.put(iIndex++, "RESULTSET_TEST");
      TABLE_NAMES.put(iIndex++, "DATE_TEST");
      TABLE_NAMES.put(iIndex++, "TIME_TEST");
      TABLE_NAMES.put(iIndex++, "TIMESTAMP_TEST");
      TABLE_NAMES.put(iIndex++, "TRANSACTION_TEST");
      TABLE_NAMES.put(iIndex++, "TRANSACTION_RELATED_TEST");
      TABLE_NAMES.put(iIndex++, "DELETE_TEST");
      TABLE_NAMES.put(iIndex++, "DELETE_RELATED_TEST");
      TABLE_NAMES.put(iIndex++, "OWN_FK_TEST");
      TABLE_NAMES.put(iIndex++, "GROUP_BASE_TEST");
      TABLE_NAMES.put(iIndex++, "GROUP_CHILD_TEST");
      TABLE_NAMES.put(iIndex++, "SAME_TEST1");
      TABLE_NAMES.put(iIndex++, "SAME_TEST2");
      TABLE_NAMES.put(iIndex++, "POOL_TEST");
      TABLE_NAMES.put(iIndex++, "POOL_TEST2");
      TABLE_NAMES.put(iIndex++, "QUERY_TEST");
      TABLE_NAMES.put(iIndex++, "QUERY_TEST_EXCEPT");
      TABLE_NAMES.put(iIndex++, "UNIQUE_COLUMN_TEST");
      TABLE_NAMES.put(iIndex++, "NULL_COLUMN_TEST");
      TABLE_NAMES.put(iIndex++, "ROLLBACK_TEST");
   }
  ...
  ) throws SQLException
  {
     ...
     try
     {
        ...
        try
        {
           // TODO: @SuppressWarnings("null") since there is no way insertStatement
